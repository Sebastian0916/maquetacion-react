...
export default function Chips() {
    ...
    // TODO: Chips need to navigate to the next page, instead of link to the first page
    // TODO: Convert chips in chip to map an object data
        ...
        <Box sx={{ width: "876px", display: "flex", gap: "8px", flexDirection: "row", alignItems: "flex-start" }}>
            <Card sx={{ width: "286.67px", backgroundColor: "#fff" }}>
                <CardContent sx={{ display: "flex", flexDirection: "Column", alignItems: "center", gap: "4px" }}>
                    ...
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="success" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="success" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="success" label="APT 203 - TORRE 1 $000,000,000 " />
                    ...
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="info" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="info" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="error" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="error" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="error" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="error" label="APT 203 - TORRE 1 $000,000,000 " />
                    <Chip onClick={handleNavigate} sx={{ width: "225px" }} size="small" color="success" label="APT 203 - TORRE 1 $000,000,000 " />
